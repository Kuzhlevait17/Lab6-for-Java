...
import ru.kuzhleva.lab3.dots.Dots;
import ru.kuzhleva.lab3.house.HouseAboveGround;
import ru.kuzhleva.lab3.lists.ImmutableListOfValues;
import ru.kuzhleva.lab3.maths.Exponentiation;
import ru.kuzhleva.lab3.weapons.*;
import ru.kuzhleva.errors.*;
                ...
                while (runner) {
                    ...
                    switch (additionalChoice) {
                        ...
                        case 3: {
                            ...
                            String[] user = {userX, userY};
                            Exponentiation.main(user);

                            String[] test = {"2,3"};
                            Exponentiation.main(test);
                            System.out.println();
                            break;
                        }
                        default: {
